# Getting Started with PyCopier

Welcome to **PyCopier**, the official Python client library for MetaRPC's ultra-low latency Trade Copier engine.

## Installation

Install PyCopier using your language's package manager:
